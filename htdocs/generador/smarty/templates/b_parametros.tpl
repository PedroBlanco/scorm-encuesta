...
<div style="text-align: left;">
    ...
    <div class="form-group">
      ...
      <textarea disabled="disabled" maxlength="200" required="required" wrap="hard" rows="4" cols="50" name="comment" class="form-control" id="comment">{$params.comment}</textarea>
    </div>
    <br /><br />
